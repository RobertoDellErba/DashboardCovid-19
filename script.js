...
.then(dati => {
    ...
    lastUpdatedData.forEach(el=>{
        ...
        <div class="relative z-neg  w-full bg_gray rounded">
        ...
        el.addEventListener('click',()=>{
            ...
            `
                ...
                <div class="grid grid-cols-1 ">
                    <div class="mb-2">
                        <p  class="float-right "><i id="closure" class="far fa-times-circle fa-2x text-gray-400"></i></p>
        ...
        `
         ...
         <div class="">
            <div class="mx-0 md:mx-5">
                <p  class="float-right  "><i id="closure" class="far fa-times-circle fa-2x text-gray-400"></i></p>
                <h2 class="text-main text-xl md:text-4xl mb-2"> Grafico positivi nazionali </h2>
            </div>
             <hr>
